    ...
    return (
        <Form onSubmit={handleSubmit(onSubmit)} type={onCloseModal ? 'modal' : 'regular'}>
            <FormRow label="Service name" error={errors?.clinicServiceName?.message}>
                <Input type="text" disabled={isWorking} id="clinicServiceName" {...register("clinicServiceName",{required:"This field is required"})}/>
            </FormRow>

            <FormRow label="Duration name" error={errors?.durationMinutes?.message}>
                <Input type="number" disabled={isWorking} id="durationMinutes" {...register("durationMinutes",{required:"This field is required"})}/>
            </FormRow>

            <FormRow label="Price" error={errors?.price?.message}>
                <Input type="number" disabled={isWorking} id="price" {...register("price",{required:"This field is required"})}/>
            </FormRow>
