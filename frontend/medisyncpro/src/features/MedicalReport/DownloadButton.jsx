...
const DownloadButton = ({ reportId, medicalReport }) => {
  /*  const downloadPDF = useCallback(async () => {
    ...
    return (
        <PDFDownloadLink document={<MedicalReportPDF data={medicalReport} isDownload />} fileName={`MedicalReport_${medicalReport.reportId}_${medicalReport.patientName}.pdf`}>
